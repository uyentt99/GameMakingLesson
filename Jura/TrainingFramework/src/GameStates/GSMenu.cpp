...
void GSMenu::Init()
{
	...
	//play button
	texture = ResourceManagers::GetInstance()->GetTexture("buttonNG");
	...
	//Setting button
	texture = ResourceManagers::GetInstance()->GetTexture("buttonS");
	button = std::make_shared<GameButton>(model, shader, texture);
	button->Set2DPosition(screenWidth / 2, 245);
	button->SetSize(200, 50);
	button->SetOnClick([]() {
	...
	//credit button
	texture = ResourceManagers::GetInstance()->GetTexture("buttonC");
	button = std::make_shared<GameButton>(model, shader, texture);
	button->Set2DPosition(screenWidth / 2, 310);
	button->SetSize(200, 50);
	button->SetOnClick([]() {
